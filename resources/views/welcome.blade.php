...
@section('content')
    ...
    <div class="container-xxl py-5">
        ...
        <div class="album py-5 bg-light " id="news">
            <div class="container ">
                    ...
                    @forelse ($berita as $post)
                        <div class="col ">
                            <div class="card shadow-sm ">
                                <img src="/storage/{{ $post->image->path }}" class="card-img-top"
                                    alt="{{ $post->title }}">
        ...
        <div class="container-fluid my-5 py-5 wow fadeIn" data-wow-delay="0.1s"
            ...
            <div class="container text-center py-5">
                ...
                <p class="text-white">We have a vision to be a leading domestic coal trading from the first-class producers
                    and
                    ensure long term sufficiency of supply for our various customers, with excellent performance and
                    first-class
                    standards serving both international and domestic coal market. In order to achieve it we have commitment
                    to
                    ...
                    <div class="col-lg-9 col-md-6 wow fadeIn" data-wow-delay="0.3s">
                        <div class="border-start border-5 border-primary ps-4 mb-5">
                            ...
                            <h1 class="display-6 text-white mb-0">
                                Large Trade in Solid, Liquid, Gas, Renewable Energy and Rare Earth Metals and Minerals
                                Mining in
                                Subsidiaries
                            </h1>
                        </div>
